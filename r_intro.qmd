...
A second check, since every assignment in this course is submitted as a knitted
document: in RStudio choose **File \> New File \> R Markdown...**, accept the
default template, and click **Knit**. If a formatted document appears, your
setup is complete. If RStudio offers to install anything at that point, let it.
