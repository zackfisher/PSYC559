...
Welcome to Applied Machine Learning in Psychology.
...
If you have not done so already, you will need to install R and RStudio. [Basic R Programming](r01_basics.qmd) walks you through it step by step. Then work through the rest of the *Introduction to R* section in the sidebar, finishing with [R Markdown and Course Setup](r07_rmarkdown.qmd), which has you install the packages we'll use all semester.
