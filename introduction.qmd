...
If you have not done so already, you will need to install R and RStudio. The [Introduction to R](r_intro.qmd) page walks you through it step by step, and then covers everything from basic programming to reading in data, working with data frames, and finally R Markdown and the packages we'll use all semester.
