...
Today we will look at the [Kaggle Marketing Analytics Data](https://www.kaggle.com/datasets/jackdaoud/marketing-data){.uri}. You can download the raw data [here](https://github.com/nailson/ifood-data-business-analyst-test).
