...
To introducing feature engineering we will explore some example data from the GSS.
...
Much attention is paid to the mechisms producing missing data in the statistics and applied sciences literature.
