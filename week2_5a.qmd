...
The whole unit is also available as one R Markdown file you can open in RStudio and run from start to finish. It downloads its own data and includes exercises at the end, so you do not need anything else.

[Download `feature_engineering.Rmd`](rmd/feature_engineering.Rmd)
:::
